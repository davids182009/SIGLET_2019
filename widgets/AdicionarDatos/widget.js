...
define([
  ...
  function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,
     ...
     *
     */
    return declare("AdicionarDatos", [_WidgetBase, _TemplatedMixin,
      ...
      postCreate: function() {
        ...
        this.isAdvancedUpload = function() {
          ...
          return (('draggable' in div) || ('ondragstart' in div &&
              'ondrop' in div)) && 'FormData' in window &&
            'FileReader' in window;
        }();

        this.urlServiceShp = this.configWidget.urlServicio;
        this.urlServiceKml = this.configWidget.urlServicio2;

        this.shp_icon.src = require.toUrl(
          'widgets/AdicionarDatos/images/filetypes/zip.svg');
        this.csv_icon.src = require.toUrl(
          'widgets/AdicionarDatos/images/filetypes/csv.svg');
        this.kml_icon.src = require.toUrl(
          'widgets/AdicionarDatos/images/filetypes/kml.svg');
        ...
        request({
          ...
          load: lang.hitch(this, function(response) {
            ...
            for (let i = 0; i < ResultLayers.length; i++) {
              let featureLayer = new FeatureLayer(ResultLayers[
                i], {
      ...
      processCSVData: function(data) {
        ...
        csvStore.fetch({
          onComplete: lang.hitch(this, function(items) {
            var objectId = 0;
            var featureCollection = this.generateFeatureCollectionTemplateCSV(
              csvStore, items);
            ...
            for (let w = 0; w < fieldNames.length; w++) {
              ...
              var matchId;
              matchId = arrayUtils.indexOf(this.latFieldStrings,
                fieldName.toLowerCase());
              if (matchId !== -1) {
                latField = fieldName;
              }
              matchId = arrayUtils.indexOf(this.longFieldStrings,
                fieldName.toLowerCase());
              if (matchId !== -1) {
                longField = fieldName;
              }
            ...
            for (let z = 0; z < items.length; z++) {
              ...
              for (let y = 0; y < attrs.length; y++) {
                ...
                attributes[attr] = isNaN(value) ? csvStore.getValue(
                  item, attr) : value;
              }
              /*
              ...
              var geometry = webMercatorUtils
                .geographicToWebMercator(new Point(longitude,
                  latitude));
              var feature = {
          ...
          onError: function(error) {
            console.error("Error fetching items from CSV store: ",
              error);
          }
        });
      },
