 ...
 * Widget que representa la funcionalidad
 * @version
 * @author
 *
 */
...
define([
    ...
    "dojo/text!./avanzada/templates/avanzada.html",
    "dojo",
    "dojo/dom",
    "dojo/on",
    'dojo/_base/lang',
  ...
  function(declare,
     ...
     *
     */
    return declare("ConsultaAvanzada", [_WidgetBase, _TemplatedMixin,
      _WidgetsInTemplateMixin], {

      templateString: templateMain,
      baseClass: "widget-ConsultaAvanzada",
      id: '',
      /**
      ...
      startup: function() {
        ...
        on(dom.byId("openTablaAtributos"), 'click', lang.hitch(this,
          this.abrirTablaAtributos));
      },
      ...
      configurarBotones: function() {
        ...
        on(dom.byId("consultaAvanzada"), "click", dojo.hitch(this,
          function(evt) {
            let capa = registry.byId("calCapa").get('value');
            let atrributo = registry.byId("calAtributoAvanzada").get(
              'value');
        ...
        on(dom.byId("limpiarConsulta"), "click", dojo.hitch(this,
          function(evt) {
      ...
      poblarAtributos: function(e) {
        let fields = null;
        this.capaWidgetSelected = this.layerExplorer.getGraphicCapaWidget(
          e);
        switch (this.capaWidgetSelected.tipo) {
          ...
          case 'D':
            ...
            this.urlCapaSeleccionada = this.capaWidgetSelected.infoCapa
              .URL + '/' + this.capaWidgetSelected.infoCapa.NOMBRECAPA;
            break;
          case 'E':
            fields = this.capaWidgetSelected.layer.fields;
            this.dataFeatures = this.capaWidgetSelected.layer.graphics;
        ...
        this.dataFields = new Memory({
          data: array
        });
        registry.byId("calAtributoAvanzada").reset();
        registry.byId("calValorAvanzada").reset();
        registry.byId("calAtributoAvanzada").set('store', this.dataFields);
      },
      ...
      features2values: function(features) {
        let nombreAtributo = registry.byId("calAtributoAvanzada").get(
          'value');
        let array = [];
        ...
        dojoArray.forEach(features, lang.hitch(this, function(
          ...
          if (feature.attributes[nombreAtributo] != undefined) {
            if (dojoArray.indexOf(ListaIndicadores, feature.attributes[
              ...
              array.push(obj);
              ListaIndicadores.push(feature.attributes[
                nombreAtributo]);
            }
          }
        ...
        switch (this.capaWidgetSelected.tipo) {
          ...
          case 'D':
            ...
            if (typeof valor === 'string') {
              ...
              let posicionApostrofe = valor.substring(1, valor.length -
                1).indexOf('\'');
